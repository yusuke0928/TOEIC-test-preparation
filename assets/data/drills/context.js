  ...
  /* ── 6. 広告：接続語と語法 ─────────────────────────── */
  {
    ...
    questions: [
      ...
      { id: 'p6c-06-3', topics: ['voice', 'vform'],
        choices: ['clipping', 'clip', 'are clipped', 'have been clipped'],
        answer: 2,
        exp: 'パネルは「取り付けられる」側なので受動態。空所の後ろに目的語がなく to standard ceiling grids と続く点が決め手。この文は特定の1回の取り付けではなく、取り付け方法を一般的に説明しているので、時制は単純現在が正しい。',
        why: ['分詞。述語動詞にならない。',
              '能動態。パネルが自ら取り付けることになる。',
              '正解。受動態の現在形。',
              '受動態の現在完了。特定の1回の取り付けがすでに完了したことを表す形で、取り付け方法を一般的に説明するこの文脈には合わない。'],
