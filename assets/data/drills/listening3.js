...
export const UNITS = [
  ...
  p2('p2w-09', {
    ...
    c: [
      ...
      "They didn't print the layout in colour.",
    ...
    w: [
      ...
      'layout の反復。印刷を単色で行ったかどうかという事柄は、問われている「クライアントが承認したか」という命題と論理的に独立で、承認の確認への応答になっていない。',
  ...
  p2('p2w-10', {
    ...
    c: [
      ...
      'The budget meeting had no delays yesterday.',
    ...
    w: [
      ...
      'budget の反復。会議に遅れがあったか否かの話であり、承認の有無に答えていない。',
  ...
  p2('p2w-12', {
    ...
    c: [
      'The invoices don\'t come to six thousand.',
    ...
    w: [
      'How much への答えの否定形であり、金額を否定しても送付済みかどうかには答えていない。',
  ...
  p2('p2w-13', {
    ...
    c: [
      ...
      'Shipping costs didn\'t go up again this quarter.',
    ...
    w: [
      ...
      'shipping の反復。輸送費の増減を述べた文であり、検査の合否には答えていない。',
  ...
  p2('p2w-14', {
    ...
    c: [
      'Yes, the invitations are ready, though the cover design hasn\'t had final approval.',
    ...
    w: [
      '招待状の準備状況と表紙デザインの承認の有無を述べた文。どちらも郵送で出してもメールで送っても同じように言えることで、送り方の二択のどちらを選んだかは決まらない。',
  ...
  p2('p2w-15', {
    ...
    w: [
      'pool を「相乗り」の意味で使った同語の引っ掛け。通勤の相乗りに自分は乗らないという別の事柄を述べているだけで、プールが閉まっているかどうかには答えていない。',
