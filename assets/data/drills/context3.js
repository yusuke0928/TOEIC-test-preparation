  ...
  /* ── 1. 社内通知：立体駐車場の改修 ─────────────────── */
  {
    ...
    questions: [
      ...
      { id: 'p6c3-01-2', topics: ['p6ins'],
        choices: [
          "The garage's overnight lighting will also be upgraded to LED fixtures during the same period, beginning with level 4 next month.",
          'The new pattern will route level 2 traffic toward the north ramp instead of the Thackeray Lane exit currently used.',
          'Level 2 was originally scheduled for resurfacing last autumn but was delayed due to weather, after last October\'s storms pushed the timeline back four months.',
  ...
  /* ── 2. E-mail：会計ソフトの定期メンテナンス ───────── */
  {
    ...
    questions: [
      ...
      { id: 'p6c3-02-2', topics: ['p6ins'],
        choices: [
          'Customers on the Enterprise plan will also lose access to the API during this time, including the reporting endpoints most finance staff check every morning.',
          ...
          'We migrated to our current server provider in 2019 and have not experienced downtime of this length since, though a similar delay occurred once before, in 2021.',
        ...
        why: ['API アクセスの制限（対象範囲を加えても）は Enterprise プラン限定の別の影響で、緊急の請求書送付という話題にはつながらない。',
              ...
              'サポートチケットの扱い（対応目安を加えても）は請求書の送付とは別件で、直後の「請求書を送りたい場合」にはつながらない。'],
    ...
    questions: [
      ...
      { id: 'p6c3-03-2', topics: ['p6ins'],
        choices: [
          ...
          'The finance team piloted Chronogate with two departments over the summer before this rollout, wrapping up in early August after six weeks of testing.',
          'Employees who exceed forty hours in a week will receive an automatic notification, triggering a review by their manager the same day.',
        ...
        why: ['正解。オフラインでも使える機能を説明しており、直後の「出張者は事前にオフラインモードをダウンロードすべき」という具体的な助言に直接つながる。',
              '試験導入の経緯（具体的な期間を加えても）は過去の話で、オフライン対応の話題にはつながらない。',
              '超過勤務の通知機能（対応フローを加えても）は別の話題で、接続環境の話にはつながらない。',
      ...
      { id: 'p6c3-03-4', topics: ['p6ins'],
        choices: [
          'Client billing addresses will need to be re-entered manually during the first week, according to a memo circulated to department heads last week.',
    ...
    questions: [
      ...
      { id: 'p6c3-04-2', topics: ['p6ins'],
        choices: [
          ...
          'A similar roof failure closed the centre for six weeks in 2014, when a different contractor handled the repair.',
          'The original overseas supplier has since said it could have delivered the steel sooner than first quoted, though only by about a week.',
        ],
        answer: 1,
        ...
        why: ['資金承認の議論は着工前の出来事で、直後の「その結果、6月の見込みより大幅に早く再開した」という結果を導く根拠にはならない。',
              ...
              '2014年の類似事案（担当業者の違いを加えても）は過去の別の出来事で、今回の工期短縮の説明にはつながらない。',
      ...
      { id: 'p6c3-04-4', topics: ['p6ins'],
        choices: [
          'Membership numbers have grown steadily since the centre introduced online booking two years ago, rising from close to nine hundred members to just over eleven hundred by this spring.',
          'The council also approved a separate budget for playground equipment at a nearby park this year, part of a wider capital-works program approved at the same March meeting.',
          'Similar reserve funds are recommended by the national association of public pools and reviewed annually by member councils.',
        ...
        why: ['会員数の伸び（具体的な人数を加えても）は別の話題で、値上げをしない理由の説明にはつながらない。',
              '遊具の予算（他の資本事業と関連付けても）は別件で、プール工事の費用の話にはつながらない。',
