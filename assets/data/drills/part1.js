...
export const UNITS = [
  ...
  p1('p1d-04', {
    ...
    w: ['布はまだ仮止めの途中で、完成した衣服をたたんでいるわけではない。',
        ...
        'ミシン自体が写真の中に存在しない。',
        '正解。トルソーに布を仮縫いしている最中である。'],
    ja: '(D) トルソーに布が仮縫いされている。',
  ...
  p1('p1d-20', {
    ...
    ja: '(D) 水泳選手がプールサイドで帽子を被っているところである。',
  ...
  p1('p1d-31', {
    ...
    w: ['前後に並んでいるのではなく、横に並んでいる。',
        '自転車は止まっておらず、同じペースで進んでいる。',
        '正解。ジョガーが自転車と横に並んで走っている。',
        '向かい合ってはおらず、同じ方向に進んでいる。'],
    ja: '(C) ジョガーが自転車と並んで走っている。',
  ...
  p1('p1d-33', {
    ...
    a: 0,
    e: '小型ボートは入口ランプの真正面の停泊枠に係留されている＝ランプの手前（in front of）。大型船は桟橋のずっと先にあり小型ボートとは離れているため、後ろ（behind）や横並び（side by side）の関係ではない。',
    w: ['正解。小型ボートはランプの手前に係留されている。',
        '大型船とは離れた位置にあり、その後ろではない。',
        '同じ場所ではなく、それぞれ別の位置に係留されている。',
        '解いている描写はない。両方とも係留されたままである。'],
    ja: '(A) 小型ボートがランプの手前に係留されている。',
    v: [['moor', '係留する'], ['pier', '桟橋']],
  }),
