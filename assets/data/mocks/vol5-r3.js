    ...
    q: [
      ...
      { tag: '詳細', s: 'What does the letter indicate about the going train?',
        c: ['It is in good order and needs only cleaning.', 'It has already been replaced.',
            'It was removed for inspection.', 'It no longer keeps accurate time and needs a full replacement.'],
        a: 0,
        e: '「時を刻む歯車列は状態が良く、清掃と注油のみでよい」とある。',
        w: ['正解。', '交換の話はない。', '取り外しには触れていない。', '不具合があるのは打鐘機構（strike train）の方で、時を刻む歯車列（going train）は清掃と注油のみでよいとされている。大掛かりな交換は不要。'] },
