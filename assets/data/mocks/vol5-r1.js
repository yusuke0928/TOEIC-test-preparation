...
export const R1 = [
  ...
  p5(128, { t: ['vform'], lv: 5,
    ...
    c: ['has reissued', 'reissues', 'was reissued', 'reissuing'],
    a: 2,
    e: '請求書は「再発行される」側なので受動態。過去の一時点までの経緯を述べているので過去形。',
    w: ['能動の現在完了。', '能動の現在形。', '正解。', '分詞。'],
  ...
  p6({
    ...
    q: [
      { tag: '態・時制', t: ['ctense', 'voice'],
        c: ['will be relocated', 'relocated', 'has relocated', 'relocates'],
        a: 0,
        e: '書庫は「移される」側なので受動態。3 月 18 日の週という未来の予定なので未来形。',
        w: ['正解。', '過去形。', '能動の現在完了。', '能動の現在形。'] },
      { tag: '接続語', t: ['connect'],
  ...
  p6({
    ...
    q: [
      ...
      { tag: '文挿入', t: ['p6ins'],
        ...
        w: ['正解。', '2 号店の計画は次文とつながらない。', '価格の据え置き期間は文脈から外れる。', '賃貸契約の更新は無関係。'] },
      { tag: '接続語', t: ['connect'],
  ...
  p6({
    ...
    q: [
      ...
      { tag: '態', t: ['voice'],
        c: ['deducts', 'will be deducted', 'deducting', 'has deducted'],
        a: 1,
        e: '交換費用は「差し引かれる」側なので受動態。今後の運用について述べているので未来形。',
        w: ['能動の現在形。', '正解。', '分詞。', '能動の現在完了。'] },
    ],
  }),
];
