  ...
  set({
    ...
    q: [
      ...
      { tag: '意図', t: ['p3int'], s: 'What does the woman mean when she says, "I\'d still get it in writing before we commit to a decision either way"?',
        c: ['She believes the labels must be destroyed.', 'She disagrees with legal\'s assessment.',
            'She wants to cancel the product entirely.', 'She wants written confirmation before acting on her own interpretation.'],
        a: 3,
        e: '自分の理解と一致していても、行動に移す前に法務から正式な書面での確認を得たいという意図。',
        w: ['ラベル廃棄には触れていない。', '見解への異議ではない。', '商品中止の提案ではない。', '正解。'] },
      { tag: '推測', s: 'What can be inferred about the existing labels?',
        c: ['They must be reprinted immediately.', 'They have already been discarded.',
            'They will be donated to another company.', 'They can likely still be used for domestic sales.'],
        a: 3,
        e: '国内での使用は低リスクとされ、既存在庫は国内向けに使える見込みだと述べられている。',
        w: ['再印刷の指示はない。', '廃棄の話もない。', '譲渡の話はない。', '正解。'] },
    ],
  }),
    ...
    questions: [
      ...
      },
      {
        ...
        choices: ['A backup unit is in use.', 'It was replaced with a newer model.',
                   'It cannot show certain video formats.', 'Extra payment is required to use it.'],
        answer: 0,
        exp: '「点検中のためバックアップ機を使う」と説明している。',
        why: ['正解。', '更新の話ではなく点検中。', '形式の制限には触れていない。', '追加料金の話はない。'],
      },
    ],
  },
  ...
  set({
    ...
    q: [
      ...
      { tag: '次の行動', s: 'What will happen by Friday?',
        c: ['A third interview will take place.', 'A written test will be administered.',
            'The scholarship will be readvertised.', 'An offer will be confirmed to the chosen candidate.'],
        a: 3,
        e: '「金曜までに採用の連絡をしよう」と決まっている。',
        w: ['3 回目の面接は予定されていない。', '筆記試験の話はない。', '再募集は述べていない。', '正解。'] },
    ],
  }),
