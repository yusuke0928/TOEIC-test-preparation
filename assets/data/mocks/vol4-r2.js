  ...
  sp({
    ...
    q: [
      { tag: '詳細', s: 'What did Corvin & Ashe discover about staff turnover?',
        c: ['It was higher than the range typical for mid-sized chains.', 'It came mainly from one branch location.',
            'It differed sharply between two onboarding methods.', 'It was concentrated heavily among senior managers.'],
        a: 2,
        e: '通常の2週間研修とその短縮版とで、初年度離職率が18パーセントと51パーセントに分かれた。',
        w: ['中規模チェーンの初年度離職率は 30〜45 パーセントとされており、同社がその範囲を上回っていたという記述はない。同社が見つけたのは、総計の内訳が 18 パーセントと 51 パーセントに割れていたこと。', '拠点別の話ではない。', '正解。', '管理職に限定した話ではない。'] },
      { tag: '詳細', s: 'Why did the company reject hiring further ahead of peak season?',
        c: ['Suitable candidates were not available that early in the market.', 'It would have exceeded the training budget for that season.',
            'It had failed at a competitor company the previous year.', 'It was prohibited under new employment regulations that year.'],
        a: 0,
