...
export const L3 = [
  ...
  talk({
    ...
    s: [
      ...
      { role: 'W-Br', text: 'I have had a look at the dimensions you sent. The good news is that the unit will fit the alcove with about four centimetres to spare on each side.' },
      ...
      { role: 'W-Br', text: 'We can order the same model with a cut-out for cabling, but that is made to order and adds eleven days.' },
  ...
  talk({
    ...
    s: [
      ...
      { role: 'M-Am', text: 'Anything remaining on the counter after half past five is reduced by half, so it is worth a look on your way round.' },
  ...
  talk({
    ...
    s: [
      ...
      { role: 'W-Au', text: 'We are not the cheapest, and we will tell you that up front. What we do is finish every garment by hand, and inspect it twice before it goes on the rail.' },
      ...
      { role: 'W-Au', text: 'For the whole of March, bring in this radio offer and your third item is free. Just say Meridian March at the counter — there is nothing to print.' },
  ...
  talk({
    ...
    s: [
      ...
      { role: 'M-Br', text: 'So this year we are changing one thing only. Each intern will be attached to a single named supervisor who owns a real deliverable with a date on it.' },
      { role: 'M-Br', text: 'I need six supervisors by the end of the month. If you are willing, e-mail Nadia — do not put your name on the shared sheet, because we are matching people to projects rather than first come, first served.' },
    ],
  ...
  talk({
    ...
    s: [
      { role: 'W-Am', text: 'Good morning, and welcome to the Kelburn Water Treatment Works. I am Ana, and I will take you through the site over the next hour.' },
      { role: 'W-Am', text: 'Before we go out, three points. Hard hats and high-visibility vests are compulsory beyond this room — you will find both in the racks by the door.' },
      ...
      { role: 'W-Am', text: 'Third, mobile phones are fine, but photography is not permitted in the control room. Everywhere else, take as many pictures as you like.' },
      { role: 'W-Am', text: 'We will finish in the education suite, where there is tea, and where I can answer anything I have not covered.' },
    ],
  ...
  talk({
    ...
    s: [
      ...
      { role: 'M-Cn', text: 'For ceremony bookings, press three. Please have the date, the venue and both parties\' full names ready before you are connected.' },
  ...
  talk({
    ...
    s: [
      ...
      { role: 'M-Am', text: 'I am not going to teach you the form. The form takes four minutes to learn and it is on the intranet.' },
      ...
      { role: 'M-Am', text: 'So we will spend most of the two hours on examples. I will hand out six real reports with the names removed, and you will mark up which sentences are observation and which are inference.' },
  ...
  talk({
    ...
    s: [
      ...
      { role: 'W-Au', text: 'Everyone booked on that class has been sent a message. If you did not receive one, please check with the desk, because it means we do not have a current number for you.' },
  ...
  talk({
    ...
    s: [
      ...
      { role: 'M-Br', text: 'From what you described in your e-mail, I do not think a half-hour slot will be enough. There are two separate issues — the service charge and the break clause — and each of those takes some working through.' },
      ...
      { role: 'M-Br', text: 'So I would suggest the middle option. If we do run over, I will not charge you for the extra time on a first meeting.' },
      { role: 'M-Br', text: 'One thing to bring: the original lease, not the scanned copy. There is an annexe that is often missing from scans, and it may well be the annexe that decides this.' },
    ],
