  ...
  talk({
    ...
    q: [
      { tag: '詳細', s: 'What is indicated about ordering certificate copies?',
        c: ['They are free of charge.', 'Certificates must be requested in person.', 'They require an appointment.', 'Online orders are processed faster.'],
        a: 3,
  ...
  talk({
    ...
    q: [
      ...
      { tag: '詳細', s: 'What is stated about the Coleford employees?',
        c: ['They will all be offered positions at the new site.', 'About half will be made redundant within the year.', 'They must reapply for their roles by next month.', 'They will receive a one-off payment rather than a monthly allowance.'],
        a: 0,
        e: '「全員にアシュベリーでの職が提示される」と明言。',
        w: ['正解。', '全員に職が提示されており、削減の対象ではない。', '再応募は不要で、全員に自動的に職が提示される。', '一時金ではなく、最初の 2 年間は交通手当が支給される。'] },
