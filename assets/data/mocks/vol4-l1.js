...
export const L1 = [
  ...
  p1(1, {
    ...
    c: [
      ...
      'Cartons have been arranged on multiple shelves.',
    ],
    a: 3,
    e: '棚に段ボール箱が複数段にわたって並べられている状態。have been arranged は完了した配置状態を表す。',
    w: ['フォークリフトは描かれていない。', 'トラックへの積み込み場面ではない。', 'はしごに登る人物はいない。', '正解。'],
    ja: '(D) 段ボール箱が複数の棚に並べられている。',
  }),

  p1(2, {
    scene: 'bank-teller', sp: 'W-Br', lv: 4,
    c: [
      'Two people are exchanging papers across a counter.',
      'A customer is counting cash at the counter.',
      'A window is being cleaned.',
      'A queue has formed outside the bank.',
    ],
    a: 0,
    e: '窓口の両側の人物が身を乗り出し、書類を挟んで向き合っている状態。',
    w: ['正解。', '現金を数えている様子は確認できない。', '窓拭きの場面ではない。', '行列は写っていない。'],
    ja: '(A) 2 人がカウンター越しに書類をやり取りしている。',
  }),
  ...
  p1(5, {
    ...
    a: 2,
    e: '停車中の車両のそばで乗客が待っている状態。動きを断定できる根拠がない選択肢は避ける。',
    w: ['進入中かどうかは写真から判断できない。', '改札の場面はない。', '正解。', '補修工事の様子はない。'],
    ja: '(C) 乗客が停車中の列車のそばで待っている。',
  }),
  ...
  p1(6, {
    ...
    c: [
      ...
      'A worker is reaching toward a piece of equipment.',
      'Products are being packaged by hand.',
      'The factory floor has been cleared of all equipment.',
    ],
    a: 1,
    e: '機械の方へ手を伸ばしている人物の姿勢。reach のポーズが該当する。',
    w: ['修理用の工具は写っていない。', '正解。', '手作業での梱包場面ではない。', '箱や機械があり空ではない。'],
    ja: '(B) 作業員が機械の方へ手を伸ばしている。',
  }),
  ...
  p2(10, { t: ['p2ind'], lv: 5, sa: 'M-Br', sb: 'W-Am',
    p: 'Isn\'t the quarterly audit due this week?',
    c: ['Yes, it audits well.', 'The auditor arrived yesterday.', 'It was pushed back to next month.'],
    a: 2,
    e: '否定疑問に対し Yes / No を使わず、延期の事実で答える応答。',
    w: ['audit の反復で意味が通らない。', '質問への直接回答になっていない。', '正解。'],
  ...
  p2(29, { t: ['p2wh'], lv: 5, sa: 'W-Au', sb: 'M-Br',
    ...
    a: 0,
    e: '選択疑問に対し、自分が対応すると申し出る形で答えている。',
    w: ['正解。', '選択疑問に Yes は不自然。', '長さの話で無関係。'],
