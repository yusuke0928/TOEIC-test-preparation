  ...
  talk({
    ...
    q: [
      ...
      { tag: '詳細', s: 'What is said about skate hire at the front desk?',
        c: ['It is closed for the whole day, only reopening tomorrow morning.', 'It has moved permanently to the café.', 'It is temporarily closed for new equipment, reopening this afternoon.', 'It now requires an advance booking.'],
        a: 2,
  ...
  talk({
    ...
    q: [
      ...
      { tag: '詳細', s: 'What does the speaker emphasise about pricing?',
        c: ['Discounts are given to returning customers who spend over one hundred pounds.', 'A fixed price is given before work begins.', 'Prices are lower in the evenings and at weekends.', 'A membership plan reduces costs after the first year.'],
        a: 1,
      ...
      { tag: '詳細', s: 'How can listeners receive a free call-out?',
        c: ['By calling in the evening rather than during the day', 'By requesting service on the north side in April', 'By paying for the job with a company credit card', 'By accepting a written quotation over the phone the same day'],
        a: 1,
        e: '「4月中は2台目の車両の導入にあわせ、町の北側での依頼は出張料を全額免除する」と述べている。地域と期間の両方を満たしたときだけの免除で、時間外の「割増なし」や事前の確定料金とは別の話である。',
        w: ['時間外について述べているのは「1時間以内に対応する」「夜間・週末の割増料金はない」ことである。割増が付かないことと、出張料そのものが免除されることは別。', '正解。', '特定のカードの話はない。', '電話での見積もり提示（確定料金）はすべての出張に対する標準の扱いであり、それだけで出張料が無料になるとは述べられていない。'] },
    ],
  }),
  ...
  talk({
    ...
    q: [
      ...
      { tag: '詳細', s: 'What will change after the January edition?',
        c: ['Far fewer copies will be printed, and an online version will be used instead.', 'The catalogue will be produced twice a year, and each printed edition will be shorter.', 'Prices will be removed from the printed catalogue.', 'An outside company will take over the printing.'],
        a: 0,
