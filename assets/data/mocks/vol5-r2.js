...
export const R2 = [
  ...
  sp({
    ...
    q: [
      ...
      { tag: '詳細', s: 'What will happen automatically for members with sauna-inclusive membership?',
        c: ['They will receive a partial refund.', 'They will have steam room access instead.',
        ...
        w: ['返金は日ごとの利用券保有者への案内。',
            '第1段落は "The sauna and steam room will be closed from Monday 7 to Friday 11 July" と述べており、スチームルームもサウナと同じ期間閉鎖される。閉鎖中にスチームルームを利用できるとするこの記述は、この一文と正面から食い違う。',
            '等級変更の話はない。', '正解。'] },
    ],
  }),
  ...
  sp({
    ...
    docs: [{
      ...
      body: [
        { t: 'kv', pairs: [
          ['Current plot holder', 'R. Yardley (plot 22)'],
          ['Requested by', 'R. Yardley'],
          ['Date', '3 March'],
        ...
        { t: 'table',
          ...
          rows: [
            ['D. Yardley', 'Spouse', "Continuing cultivation after holder's relocation"],
          ] },
    ...
    q: [
      { tag: '詳細', qid: 'v5q159r', s: 'Why is plot 22 being transferred?',
        c: ['R. Yardley has decided to move to a new home.', 'The committee has asked the holder to return the plot.',
            'R. Yardley has already reached the two-plot maximum.', 'R. Yardley has given up gardening on medical advice.'],
        a: 0,
        e: '表の「Continuing cultivation after holder\'s relocation」から、現保有者の転居に伴い区画が親族へ移されると分かる。',
        w: ['正解。「Continuing cultivation after holder\'s relocation」から、現保有者が転居することになったために区画が移されると分かる。',
            '矛盾。書式上部の項目欄の「Requested by: R. Yardley」および表の Reason 欄の「Continuing cultivation after holder\'s relocation」から、移転を求めたのは委員会ではなく現保有者本人であり、理由も転居に伴うものである。委員会が返却を求めたとするこの記述は本文と正面から矛盾する。',
            '矛盾。書式上部の項目欄の「Plots currently held: 1 of a maximum of 2」から、現保有者が保有するのは1区画のみで、上限の2区画にはまだ達していない。上限に達しているとするこの記述は本文と正面から矛盾する。',
            '誤り。医師の助言で園芸をやめたという記載はこの書式のどこにもない。'] },
      { tag: '推測', t: ['p7inf'], s: 'What can be inferred if the new holder has not attended a committee meeting?',
        c: ['The transfer will be approved for one season only.', 'The transfer will be rejected immediately.',
            'A late fee will be charged for the transfer.', 'The new holder must attend two meetings before approval.'],
        a: 0,
        e: '「出席実績がない場合は、次回の会合に出席することを条件に 1 作期限定で暫定承認される」とある。',
        w: ['正解。「will be provisionally approved for one growing season only, pending attendance at the next scheduled meeting」の言い換え。',
            '誤り。出席実績がなくても却下されるのではなく、次回の会合への出席を条件に 1 作期限定で暫定承認される。',
            '誤り。この書式に料金についての記載は一切ない。',
            '矛盾。本文は「Transfers without this attendance will be provisionally approved for one growing season only, pending attendance at the next scheduled meeting」と述べており、出席実績が無くてもまず1作期限定で暫定承認され、条件となるのは次回1回の会合への出席のみである。承認の前に2回の会合への出席が必要だとするこの記述は本文と正面から矛盾する。'] },
    ],
  }),
