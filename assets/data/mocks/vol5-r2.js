    ...
    q: [
      ...
      { tag: '詳細', s: 'What is stated about the punch-card machines?',
        c: ['They will be kept as a permanent backup.', 'They will be moved to a different entrance.',
            'They will remain for one week before being removed.', 'They have already been removed.'],
        a: 2,
        e: '「最初の 1 週間だけ新旧併用し、1 月 27 日以降は打刻機を完全に撤去する」とある。',
        w: ['恒久的な予備としては残らない。', '移設の話はない。', '正解。', 'まだ稼働している。'] },
    ],
  }),
  ...
  sp({
    ...
    q: [
      ...
      { tag: '推測', t: ['p7inf'], s: 'What can be inferred if the new holder has not attended a committee meeting?',
        c: ['The transfer will be approved for one season only.', 'The transfer will be rejected outright.',
            'A late fee will be charged.', 'The current holder will lose their remaining plot.'],
        a: 0,
        e: '「出席実績がない場合は、次回の会合に出席することを条件に 1 作期限定で暫定承認される」とある。',
        w: ['正解。', '却下ではなく条件付きで承認される。', '延滞料金の話はない。', 'もう一方の区画への言及はない。'] },
    ],
  }),
