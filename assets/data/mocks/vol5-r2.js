    ...
    q: [
      ...
      { tag: '推測', t: ['p7inf'], s: 'What does Ms. Oyelaran imply about using birch?',
        c: ['It would exceed the planting budget on its own.', 'It is difficult to obtain locally because most nurseries do not stock it.',
            'It would fail to provide shade exactly when it is most needed.', 'It was never mentioned by the client at any stage of the brief.'],
        a: 2,
        e: '「シラカバは 1 年の半分近く葉を落とすため、最も日陰が必要な夏に日陰を提供できない」という趣旨。',
        w: ['予算増の理由は高木種全般のコスト。', '入手の難しさには触れていない。シラカバを避ける理由として挙げられているのは落葉の時期だけである。', '正解。', '筆者は "On the choice of species for the south edge: you mentioned birch." と述べており、シラカバは依頼主自身が挙げた樹種である。依頼主が一度も挙げていないとするこの記述は本文と正面から矛盾する。'] },
    ],
  }),
    ...
    q: [
      ...
      { tag: '詳細', s: 'What was unusual about the tracking of the change?',
        c: ['It continued for two years rather than the more typical shorter period.', 'It measured revenue rather than call length.',
            'It showed no fall in call length.', 'It was conducted by an outside consultancy.'],
        a: 0,
        e: '「この種の変更にしては珍しく」2 年間の追跡調査を行った点が特異だと述べている。',
        w: ['正解。', '測定対象は通話時間と再架電率。', '第3段落は average call length fell by 8 percent、さらに by year two, average call length was down 19 percent と、通話時間が下がったことを二度明記している。低下が見られなかったとするこの記述は本文と正面から矛盾するので偽。', '外部委託の話はない。'] },
