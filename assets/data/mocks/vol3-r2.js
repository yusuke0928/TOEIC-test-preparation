  ...
  sp({
    ...
    q: [
      ...
      { tag: '詳細', s: 'What is indicated about the Wednesday storytime sessions?',
        c: ['They will be cancelled if the weather is poor.', 'They will require advance registration.',
            'They will be shortened during the closure.', 'They will be held in the first-floor community room.'],
        a: 0,
        e: '屋外の中庭に移すが、雨天の場合は屋内に移さず中止すると明記されている。',
        w: ['正解。', '事前登録の記載はない。', '短縮の記載はない。', '一階の会議室ではなく屋外の中庭に移る。'] },
    ],
  }),
  ...
  sp({
    ...
    q: [
      { tag: '詳細', s: 'Why was the inspection date changed?',
        c: ['The inspector is unavailable on the originally planned date.', 'Staff requested a different date.',
            'The warehouse will be closed on 14 March.', 'A required part was delayed in shipping.'],
        a: 0,
        e: '検査員はブリストル拠点から来るが、14 日に動かせない先約があるためと説明されている。',
        w: ['正解。', 'スタッフからの要望ではない。', '閉鎖の話はない。', '部品の遅延には触れていない。'] },
