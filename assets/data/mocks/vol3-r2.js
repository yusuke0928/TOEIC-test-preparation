    ...
    q: [
      { tag: '詳細', s: 'What did Harrowgate discover about its warranty claims?',
        c: ['They were higher than the industry average.', 'They came mainly from a small group of repeat customers.',
            'They differed sharply between two installation methods.', 'They concentrated in one region.'],
        a: 2,
      ...
      { tag: '詳細', s: 'Why did the company reject refusing warranty coverage for self-installed units?',
        c: ['National consumer regulations prohibited it.', 'It had failed at a competitor before.',
      ...
      { tag: '推測', t: ['p7inf'], s: 'What does the final paragraph suggest?',
        c: ['Averages can conceal distinct groups within the data.', 'Customer surveys are more reliable than claim data.',
            'The company should shorten warranty periods.', 'Kitchen appliances differ from other product categories.'],
        a: 0,
