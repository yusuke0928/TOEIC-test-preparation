  ...
  sp({
    ...
    q: [
      ...
      { tag: '詳細', s: 'What is stated about the cost of replacement panels?',
        ...
        w: ['正解。', '単価は上がっており、初年度に両方とも下がったという記述もない。', '40 パーセント上昇と明記。', '総額は減少している。'] },
      { tag: '位置選択', qid: 'v2q174r', t: ['p7ins'], insertAt: 1,
        ...
        w: ['正解。直前の文の「1 July 開始」を That start date で受け、6 May から8週間後という計算が過不足なく一致する。',
            '[2] の前後は予算と工期の総括で、scheme にも1 Julyにも触れておらず、That start date の指す先が無い。',
            '[3] の前後は資材と単価の話であり、scheme や1 Julyへの言及はここにも無く、指示対象が無い。話もすでに「初年度」の実績まで進んでおり、5月の期日変更に立ち戻る合図も無い。',
            '[4] の前後は原因分析であり、scheme や1 Julyへの言及はここにも無く、指示対象が無い。時系列も初年度の実績より後まで進んでいる。'] },
