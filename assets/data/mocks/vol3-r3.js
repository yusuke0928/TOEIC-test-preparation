  ...
  sp({
    ...
    q: [
      { tag: '概要', s: 'What are the writers discussing?',
        c: ['Whether to switch to a different magnet supplier for future batches', 'Whether to postpone a product launch until batch 4470 is cleared',
    ...
    q: [
      ...
      { tag: '詳細', s: 'What is stated about the cost of the replacement housings?',
        c: ['The unit price rose but total spending fell.', 'Both unit price and total spending fell.',
            'The unit price was unchanged.', 'Total spending rose in the first full year after conversion.'],
        a: 0,
