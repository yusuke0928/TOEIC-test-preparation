    ...
    q: [
      ...
      { tag: '詳細', s: 'What is stated about the cost of the replacement housings?',
        c: ['The unit price rose but total spending fell.', 'Both unit price and total spending fell.',
            'The unit price remained flat.', 'Total spending rose in the first full year after conversion.'],
        a: 0,
        e: '1 基あたりは 35 パーセント高いが、被害件数が 214 → 61 に減ったため総額は 68 パーセント減。',
        w: ['正解。', '単価は上がっている。', '35 パーセント上昇と明記。', '総額はむしろ初年度に 68 パーセント減少したと明記されている。'] },
      { tag: '位置選択', qid: 'v3q174r', t: ['p7ins'], insertAt: 4,
        sentence: 'The fall of 153 incidents comfortably outweighed the 35 percent rise in the cost of each housing replaced.',
        s: 'In which of the positions marked [1], [2], [3], and [4] does the following sentence best belong?　"The fall of 153 incidents comfortably outweighed the 35 percent rise in the cost of each housing replaced."',
        c: ['[1]', '[2]', '[3]', '[4]'],
        a: 3,
        e: '挿入文の「the fall of 153 incidents」という定名詞句は、直前までに登場した数値だけからは根拠づけられず、214から61への減少（214−61＝153、段落3の末尾で示されている）によって初めて成立する。214と61が出そろった段落3の末尾より後でなければこの定名詞句は指す先を持たず、それに該当するのは [4] だけである。',
        w: ['[1] の前後で判明している数値は1,340と1,600（差260）だけで、214も61もまだ登場しておらず、153という差分も「the fall of 153 incidents」も根拠を持たない。',
            '[2] の前後で新たに加わる数値は5パーセントと3週間で、214・61は依然として登場しておらず、153も「the fall of 153 incidents」も成立しない。',
            '[3] の直前までに出ているのは35パーセントのみで、214と61は直後の文で初めて示される。この時点では「the fall of 153 incidents」を裏づける数値がまだ本文に無い。',
            '正解。214と61は段落3の末尾ですでに示されており、その情報が出そろったあとに置かれているので、214−61＝153という「the fall of 153 incidents」が過不足なく成立する。'] },
