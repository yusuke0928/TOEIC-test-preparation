...
export const L1 = [
  ...
  p2(11, {
    ...
    a: 1,
    e: 'Why don\'t we ...? は「〜してはどうか」という提案。応答は提案を受け入れるか、実行を妨げる事情を挙げるかになる。正解は「彼女は来週まで勤務を始めない」と、補充を任せようにも当人がまだ勤務を始めていないという事情を挙げている。なお、この形は字義どおり「なぜ〜しないのか」とも読めるので、妨げになる事情を Because で導いた応答なら正解になりうる。Because の選択肢が外れるのは、先頭の語ではなく述べている内容による。',
    w: ['場所を答えており、提案への応答になっていない。', '正解。新しいインターンはまだ勤務を始めていない。', '妨げになる事情を Because で導く応答なら成立するが、ここで述べているのは「フォルダーが足りない」という補充が必要な理由で、提案を後押しする材料。補充を誰に任せるか、インターンに任せられるかどうかとは論理的に独立しており、提案を受け入れる材料にも妨げる材料にもなっていない。'],
  ...
  p2(12, {
    ...
    a: 2,
    e: '設問が尋ねているのは砂利の到着時期（今朝かどうか）。正解の応答は運転手からの連絡として「昼過ぎになる」と到着時刻そのものを言い直しており、今朝という時点を退けて代わりの時点を示すので、問われている内容に正面から答えている。応答が Yes/No で始まるかどうかは判断材料にならない——見るのは、続く内容が「いつ届くか」という問いに答えているかどうか。',
    w: [
      'Yes は「今朝届く予定だ」を認めることになるが、続く内容は発注を取り消したという話で、届く予定があるという前提と食い違う。',
      '自分の所在を述べているだけで、砂利が今朝届くかどうかに答えていない。',
      '正解。運転手から昼過ぎになると連絡があった、と到着時刻そのものを答えており、今朝の到着は無いことがその内容から分かる。',
    ],
