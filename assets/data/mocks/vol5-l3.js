    ...
    q: [
      ...
      { tag: '推測', s: 'What is implied about passengers who are reseated?',
        c: ['They must request a new seat at the service desk.', 'They will receive a new boarding pass automatically at the gate.',
            'They will be moved to a later flight departing the next day.', 'They will receive a discount voucher for a future flight booking.'],
        a: 1,
  ...
  talk({
    ...
    q: [
      { tag: '概要', s: 'What is being proposed?',
        c: ['Requiring justification after each trip is booked.', 'Banning all business travel immediately.',
