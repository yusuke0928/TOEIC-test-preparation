  ...
  talk({
    ...
    q: [
      ...
      { tag: '詳細', s: 'Why is the swap necessary?',
        c: ['The grill station is being repaired.', 'A staff member called in sick.',
            'A delivery needs to be stored before it warms up.', 'A new till is being installed.'],
        a: 2,
        e: '「生樽の配達が遅れており、庭先で温まる前にすぐ貯蔵室に運び込む必要がある」が理由。',
        w: ['修理の話ではない。', '欠勤の話はない。', '正解。', 'レジ交換はバーの決済機の話。'] },
  ...
  talk({
    ...
    q: [
      { tag: '詳細', s: 'Why has the current bridge been restricted to pedestrians only?',
        c: ['A structural survey found it unsafe for cyclists and scooters.', 'A previous accident closed it to other traffic.',
            'The council reduced its maintenance budget.', 'Nearby construction blocked wider access.'],
        a: 0,
        e: '「構造調査で自転車やスクーターの荷重に耐えられないと判明したため」と説明されている。',
        w: ['正解。', '事故の話はない。', '維持費削減には触れていない。', '周辺工事による通行止めではない。'] },
