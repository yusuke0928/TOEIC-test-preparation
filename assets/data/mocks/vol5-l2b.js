     ...
     なので ['p3detail'] に修正した。stem・choices・answer・id は変更していない。 */
  {
    ...
    questions: [
      ...
      { id: 'v5q54r', no: 54, tag: '詳細', stem: 'When can the woman collect the rental kit?',
        choices: ['As soon as the shop opens that morning.', 'Only after she pays a deposit in person.', 'Ten in the morning on the wedding day.', 'Any time after four the day before.'],
        answer: 3,
      ...
      { id: 'v5q55', no: 55, tag: '詳細', stem: 'By when must she return the kit?',
        choices: ['Within two hours of the wedding ending.', 'By four the following afternoon.',
            'By ten the following morning.', 'By the end of the same day.'],
        answer: 2,
        exp: '「翌朝 10 時までに返却すれば 1 日分の料金でまかなえる」と案内されている。',
        why: ['担当者が返却期限として挙げたのは「翌朝 10 時」という時刻で、式の終了時刻を起点にした制限は述べていない。', '「4 時」は「前日の午後 4 時以降なら受け取れる」という受け取り開始の時刻として出てくる数字で、返却の期限ではない。', '正解。', '担当者は「翌朝 10 時までに戻せば 1 日分の料金でまかなえる」と述べており、期限は式当日の終わりではなく翌朝になる。'],
        topics: ['p3detail'] },
    ],
  },
     ...
     判断できない）。選択肢を変えたため id を新規採番する（v5q60r3）。 */
  {
    ...
    questions: [
      ...
      { id: 'v5q60r3', no: 60, tag: '詳細', stem: 'Why does the woman recommend the annual permit?',
        choices: ['It includes a space in the covered section.', 'It costs less over a full year.', 'It can be transferred to another vehicle.', 'It is available only to new employees.'],
        answer: 1,
      ...
      { id: 'v5q61', no: 61, tag: '詳細', stem: 'What must happen before the employee can use Zone A?',
        choices: ['He must provide a doctor\'s note in person.', 'Facilities must approve the request.',
            'He must pay an additional deposit.', 'He must wait six months.'],
        answer: 1,
        exp: '「施設管理の承認が必要」と述べられている。',
        why: ['診断書の提出方法には触れていない。', '正解。', '追加保証金の話はない。', '「6 週間」であって 6 か月ではない。'],
        topics: ['p3detail'] },
    ],
  },
     ...
     選択肢を変えたため id を新規採番する（v5q67r3）。 */
  {
    ...
    questions: [
      { id: 'v5q65r', no: 65, tag: '詳細', stem: 'Why did sales increase sharply in one region during the second quarter?',
        choices: ['The company ran a temporary discount campaign there.', 'A rival company shut down its local operations.', 'A new product line launched exclusively in that region.', 'The region added extra sales staff for the quarter.'],
        answer: 0,
        exp: '男性が「それは春のキャンペーンによるもので、その地域だけ大幅な割引を実施したためだ」と説明している。',
        why: ['正解。', '男性は増加の原因を「春のキャンペーン＝その地域だけで実施した大幅な割引」と明示しており、競合他社の動向には一切触れていない。', '男性が挙げた原因は割引キャンペーンのみで、新製品の投入は会話のどこにも出てこない。', '男性が挙げた原因は割引キャンペーンのみで、販売体制や人員には触れていない。'],
        topics: ['p3detail'] },
      { id: 'v5q66', no: 66, tag: '意図', stem: 'What does the man mean when he says, "Whether it \'worked\' depends on margin"?',
        choices: ['The campaign should be repeated in every region.', 'The sales data was recorded incorrectly.', 'Increased sales volume alone does not mean the campaign was profitable.', 'The results will not be known for several months.'],
        answer: 2,
        exp: '直後に「割引を考慮すると大半が赤字だった」と続く。件数の増加＝成功ではないという趣旨。',
        why: ['この地域限定の施策だった。', 'データの誤りは述べていない。', '正解。', '結果はすでに判明している。'],
        topics: ['p3int'] },
      { id: 'v5q67r3', no: 67, tag: '次の行動', stem: 'What does the man propose?',
        choices: ['Increasing prices across the entire range.', 'Hiring an additional regional sales manager.', 'Testing a smaller discount in the autumn.', 'Reporting the loss to the finance committee.'],
        answer: 2,
        exp: '「秋に規模を半分にした案を提案する」と述べている。',
        why: ['男性が提案したのは「秋に規模を半分にした割引を試す」ことだけで、値上げには一切触れていない。', '男性が提案したのは「秋に規模を半分にした割引を試す」ことだけで、人員の追加採用は会話に出てこない。', '正解。', '男性が提案したのは「秋に規模を半分にした割引を試す」ことだけで、損失を財務委員会に報告するとは述べていない。'],
        topics: ['p3detail'] },
    ],
  },
     ...
     新規採番する（v5q70r）。 */
  {
    ...
    questions: [
      ...
      { id: 'v5q69r3', no: 69, tag: '詳細', stem: 'What does the woman tell the man to have ready?',
        choices: ['His confirmation of the booking.', 'A ticket bought on the day.', 'Identification issued by the venue.', 'A letter from his employer.'],
        answer: 0,
