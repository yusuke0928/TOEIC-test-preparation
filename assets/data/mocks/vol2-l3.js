...
export const L3 = [
  ...
  talk({
    ...
    s: [
      ...
      { role: 'W-Au', text: 'One value, the thyroid level, is at the very top of normal. On its own that is not a diagnosis. But combined with the weight loss you described, it is worth watching.' },
      { role: 'W-Au', text: 'I do not want to start medication on a single reading. What I would suggest is a repeat test in six weeks, and in the meantime weighing her at home once a week — same scales, same time of day.' },
      { role: 'W-Au', text: 'If you can e-mail me those weights before the repeat test, that will tell us more than the blood work alone.' },
      { role: 'W-Au', text: 'Do call if anything changes before then. I am in on Tuesdays, Wednesdays and Fridays.' },
    ],
  ...
  talk({
    ...
    s: [
      ...
      { role: 'M-Br', text: 'Passengers with reserved seats do not need to do anything; your reservation will be honoured on the coach. Those travelling with bicycles should speak to the conductor before Perth, as the coaches can take four bicycles in total.' },
      { role: 'M-Br', text: 'If you would prefer to travel tomorrow instead, your ticket will be valid on any service, and a refund of the difference will be made at the ticket office.' },
    ],
  ...
  talk({
    ...
    s: [
      { role: 'W-Am', text: 'Last item. You will have seen that we are moving to a single supplier for laboratory consumables from July.' },
      ...
      { role: 'W-Am', text: 'The contract includes a four-hour response commitment on critical items and a penalty clause we can actually enforce. I have seen the previous version, and it was neither of those things.' },
      { role: 'W-Am', text: 'What I am not going to pretend is that this removes risk. It concentrates it. The judgement we made is that one supplier we can hold to account beats four we cannot.' },
  ...
  talk({
    ...
    s: [
      { role: 'M-Cn', text: 'If you have ever stood in your kitchen at seven in the evening wondering what to do with half a cabbage, this is for you.' },
      { role: 'M-Cn', text: 'Larder is a weekly cookery class at the Bridgeside Community Kitchen, and it is built around what you already have rather than a shopping list.' },
      { role: 'M-Cn', text: 'Each session starts with whatever the group brings in. Our tutor, Marguerite Oyelowo, then teaches three techniques you can apply to almost anything — not three recipes you will make once and forget.' },
      ...
      { role: 'M-Cn', text: 'The first session of each month is free for anyone who has not attended before. You do not need to book for that one — just turn up.' },
    ],
  ...
  talk({
    ...
    s: [
      { role: 'W-Br', text: 'Welcome, all of you, to your first day on the ward reception desk. I am going to skip the software, because you will learn that faster by doing it.' },
      { role: 'W-Br', text: 'Instead I want to spend our twenty minutes on the one thing that is hard to teach, which is what to do when someone at the desk is distressed.' },
      { role: 'W-Br', text: 'The instinct is to give information quickly. Resist it. Most people at that desk cannot take in information until someone has acknowledged what they are feeling.' },
      { role: 'W-Br', text: 'So the sequence is: acknowledge, then find out what they actually need, then give the information. It sounds slow. In practice it is faster, because you answer the right question the first time.' },
      { role: 'W-Br', text: 'The one thing you must never do is guess about a patient\'s condition. If you do not know, say you do not know and find someone who does. Nobody has ever been disciplined here for saying "let me find out".' },
    ],
  ...
  talk({
    ...
    s: [
      ...
      { role: 'M-Am', text: 'If you are calling about calibration certificates, these are now issued electronically within two working days of the service visit. Please check the e-mail address we hold for you before calling, as most missing certificates are simply going to a former colleague.' },
      { role: 'M-Am', text: 'To continue holding, stay on the line. Your call will be answered in the order received. Alternatively, leave a message after the tone and we will call back the same working day.' },
    ],
  ...
  talk({
    ...
    s: [
      { role: 'W-Am', text: 'Quick word before we open. The rota on the board is out of date in one respect.' },
      ...
      { role: 'W-Am', text: 'That is only for today. Tomorrow the rota stands as printed.' },
    ...
    ja: '開店前の短い連絡。掲示の勤務表が 1 点だけ古い。本日、デリカウンター担当は正午から在庫室担当と入れ替わること（チーズの納品が遅れて届き、そのまま冷蔵庫に入れる必要があるため）。これは本日限りで、翌日は掲示どおり。2 点目、レジのカードリーダーが交換され、新しい機械は挿入ではなくタッチ式なので、その説明を 1 日に 200 回ほど口頭ですることになる。3 点目、試食は 10 時ではなく 11 時から。先週は 1 時間早く出したため昼前に品切れになった。',
    ...
    q: [
      { tag: '図表', s: 'Look at the graphic. Who will move to the stockroom at midday?',
        ...
        a: 2,
        e: '「本日（土曜）のデリカウンター担当」が該当。表の土曜デリは Nadia。',
        w: ['土曜はレジ担当。', '土曜はベーカリー担当。', '正解。', '在庫室担当で、入れ替わる相手側。'] },
  ...
  talk({
    ...
    s: [
      ...
      { role: 'M-Br', text: 'I know that is unwelcome, and I want to explain where it goes. The building\'s boiler is at the end of its life. Replacing it is a capital cost we cannot meet from reserves alone.' },
      ...
      { role: 'M-Br', text: 'Anyone who books before the end of August will be charged the current rate for bookings up to the end of the year, so if your group has a regular slot, it is worth confirming your dates now.' },
    ],
  ...
  talk({
    ...
    s: [
      { role: 'M-Cn', text: 'Hi Yasmin, it is Rob at Ferndown Print about the programme booklets for the twelfth.' },
      ...
      { role: 'M-Cn', text: 'On paper that means no surcharge. The complication is the paper stock you have specified — it comes from a mill in Finland and our own delivery is Thursday week.' },
      ...
      { role: 'M-Cn', text: 'My honest view is that nobody will notice the difference in weight, and you would save the surcharge. But it is your call, so let me know today if you can.' },
    ],
    ja: 'ファーンダウン印刷のロブから、12 日のプログラム冊子についての留守電。データは火曜の朝に届き、納品は 11 日必要なので営業日は 6 日ある。書面上は追加料金なしだが、指定された用紙がフィンランドの製紙工場からで、自社への入荷は翌週木曜という問題がある。したがって、用紙の入荷を待って納期を 1 段階上げて日程に間に合わせるか、在庫のあるほぼ同一だがわずかに薄い用紙に切り替えるかの二択。ロブの見解は「重さの違いに気づく人はいないので追加料金を節約できる」だが、判断は依頼者に委ね、可能なら当日中の連絡を求めている。',
