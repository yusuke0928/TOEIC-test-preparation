  ...
  talk({
    ...
    q: [
      ...
      { tag: '詳細', s: 'What must listeners do before the end of May?',
        c: ['Report any missing catalogue items', 'Return unused stock',
            'Place their final orders with the old suppliers', 'Complete the optional training'],
        a: 0,
        e: '「必要な品目が新カタログにない場合は 5 月末までにバーラトへ」と明確に期限が示されている。',
        w: ['正解。', '在庫返却の話はない。', '旧業者への最終発注には触れていない。', '研修は任意で期限の指定がない。'] },
    ],
  }),
    ...
    q: [
      ...
      { tag: '詳細', s: 'What is given as the usual reason certificates are not received?',
        c: ['Payment has not been received.', 'The service visit was not completed.',
            'The postal system is slow.', 'They are sent to an outdated address.'],
        a: 3,
  ...
  talk({
    ...
    q: [
      ...
      { tag: '推測', s: 'What is suggested about the construction timetable?',
        c: ['It requires approval from all members.', 'It has been delayed by two years.',
