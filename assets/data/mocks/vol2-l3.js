  ...
  talk({
    ...
    q: [
      { tag: '詳細', s: 'What does the message say about error codes?',
        c: ['They indicate the instrument must be returned.', 'Customers should report them by e-mail.',
  ...
  talk({
    ...
    q: [
      ...
      { tag: '詳細', s: 'What is the problem with the specified paper?',
        c: ['It has been discontinued by the mill earlier this year.', 'It will not arrive in time without a change.',
        ...
        w: ['製造終了の話はない。', '正解。', '実際の差は「ごくわずかに軽い」代替紙との比較であり、機械が扱えないほど重いという記述はない。', '用紙代や予算超過の話は出ていない。'] },
