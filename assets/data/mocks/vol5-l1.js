...
export const L1 = [
  ...
  p2(7, { t: ['p2wh'], lv: 3, sa: 'W-Br', sb: 'M-Am',
    ...
    w: ['How often に Yes は不可。', '「何についてのものか」への答えで、配信の頻度は述べていない。', '正解。'],
  ...
  p2(8, { t: ['p2ind'], lv: 5, sa: 'M-Cn', sb: 'W-Am',
    ...
    c: ['I\'m still typing them up.', 'The meeting ran over by almost an hour.', 'Sure, each recording is a minute long.'],
    a: 0,
    e: '依頼に対し「まだ清書中です」と、完了していないことを間接的に伝える応答。',
    w: ['正解。', '会議が予定より長引いたという事実。会議の長さと、議事録が送れる状態にあるかどうかは互いに独立で、長引いても清書済みのことはあり、短くても未着手のことはある。依頼の可否を決める材料になっていない。', 'minutes（議事録）と minute（分）の音の引っ掛け。述べているのは録音1本の長さで、録音が何分であっても議事録が送れるかどうかは変わらない。'],
  ...
  p2(12, { t: ['p2ind'], lv: 5, sa: 'M-Br', sb: 'W-Au',
    ...
    c: ['The bulletin is published on the intranet.', 'Approval isn\'t required for minor edits.', 'Not everyone here approves of the new format.'],
    a: 1,
    e: '否定疑問に Yes / No を使わず、「軽微な修正には承認は不要」と条件を示して答える応答。',
    w: ['publish の反復。社内報がどこに掲示されるかという配信媒体の話で、いま手元の文書に承認が要るかどうかとは独立している（社内報の掲載先は、承認が必要でも不要でも同じように成り立つ）。', '正解。', 'approve of は「〜をよいと思う」という別の語義で、手続き上の approval（承認）とは別物。体裁への賛否がどちらであっても、承認が手続きとして要るかどうかは変わらないので、問われている命題と独立している。'],
    ja: 'これを公開する前に承認が必要ではないですか。→ (B) 軽微な修正には承認は不要です。' }),

  p2(13, { t: ['p2wh'], lv: 3, sa: 'W-Am', sb: 'M-Au',
    p: 'Which printer has the colour toner?',
    c: ['On the second Monday of each month.', 'The one near the stairs.', 'Yes, it prints thirty double-sided pages a minute.'],
    a: 1,
    e: 'Which に対して特定のプリンターを答えている。',
    w: ['How often への答えで、どのプリンターかという問いには答えていない。', '正解。', 'Which で始まる疑問に Yes では答えられない。印刷速度もトナーの色とは無関係。'],
    ja: 'どのプリンターにカラートナーが入っていますか。→ (B) 階段の近くのものです。' }),

  p2(14, { t: ['p2wh'], lv: 5, sa: 'M-Cn', sb: 'W-Br',
    p: 'Would you like the window seat or the aisle?',
    c: ['Yes, I would like that.', 'The window was cleaned earlier this morning.', 'Either is fine, honestly.'],
    a: 2,
    e: '選択疑問に「どちらでも構わない」と答える応答。二択を示された側は、一方を選ぶか、どちらでもよいと述べるかのいずれかで応じることになる。',
    w: ['that が窓側・通路側のどちらを指すのか定まらず、選択を伝えたことにならない。', 'window の反復。窓の清掃は座席の希望とは無関係。', '正解。'],
    ja: '窓側と通路側、どちらがよろしいですか。→ (C) 正直、どちらでも構いません。' }),

  p2(15, { t: ['p2wh'], lv: 5, sa: 'W-Au', sb: 'M-Am',
    p: 'Isn\'t the workshop supposed to start at nine?',
    c: ['Yes, the workshop covers three separate modules.', 'It was moved to ten.', 'The room seats forty.'],
    a: 1,
    e: '否定疑問に事実で答える応答。「10 時に変更された」と時刻がずれたことを伝えている。',
    w: ['workshop の反復。Yes に続くのは「モジュールが3つある」という構成の話で、9 時開始かどうかとは独立している（モジュール数は開始時刻が何時であっても同じ）。肯定した内容の裏付けになっていない。', '正解。', '定員は開始時刻とは関係がない。'],
  ...
  p2(16, { t: ['p2ind'], lv: 4, sa: 'M-Br', sb: 'W-Am',
    ...
    c: ['Through the car park, if the gate\'s open.', 'The annex was finished in September.', 'About two hundred people work there.'],
    a: 0,
    e: '経路を尋ねられ、条件付きで具体的なルートを答えている。',
    w: ['正解。', '完成した時期を述べており、行き方には答えていない。', '在籍している人数を述べており、行き方には答えていない。'],
  ...
  p2(19, { t: ['p2wh'], lv: 5, sa: 'W-Au', sb: 'M-Br',
    ...
    c: ['Yes, feedback matters.', 'It\'s coming this Monday instead.', 'Friday\'s session starts at half past two.'],
    a: 1,
    e: '否定疑問に対し、遅れた事情を述べる間接応答。',
    w: ['一般論で問いに答えていない。', '正解。', 'Friday の反復。述べているのは別の会合が何時に始まるかで、フィードバックの期日が金曜だったかどうかとは独立している（開始時刻は期日が守られていてもいなくても同じ）。'],
  ...
  p2(20, { t: ['p2wh'], lv: 4, sa: 'M-Cn', sb: 'W-Am',
    ...
    w: ['開始時刻は問いに答えていない。', 'that が二つの案のどちらを指すのか定まらず、選択を伝えたことにならない。', '正解。'],
    ja: '予定を変更するか、それとも通話を短くするか、どちらがよいですか。→ (C) 短くしましょう。' }),

  p2(21, { t: ['p2ind'], lv: 5, sa: 'W-Br', sb: 'M-Au',
    p: 'Can you believe the printer jammed again?',
    c: ['The printer by the window is grey.', 'I\'ll call maintenance now.', 'Yes, I believe every word.'],
    a: 1,
    e: '不満・驚きの表明に対し、対応行動で応じる応答。',
    w: ['printer の反復。色は不満の表明への応答にならない。', '正解。', 'believe を文字通りの「信じる」の意味に取った引っ掛け。'],
    ja: 'プリンターがまた詰まったなんて信じられますか。→ (B) 今すぐ保守担当に連絡します。' }),

  p2(22, { t: ['p2wh'], lv: 3, sa: 'M-Am', sb: 'W-Au',
    p: 'Where did you file the original contract?',
    c: ['Yes, it\'s filed.', 'It was signed in early March.', 'Under the client\'s name.'],
    a: 2,
    e: 'Where に対して具体的な保管場所で答えている。',
    w: ['Where で始まる疑問に Yes では答えられない。', '署名した時期を述べており、保管場所には答えていない。', '正解。'],
  ...
  p2(24, { t: ['p2wh'], lv: 5, sa: 'M-Cn', sb: 'W-Br',
    ...
    c: ['Finance pushed the deadline back a week.', 'Yes, numbers matter to everyone.', 'Those numbers came from the audit.'],
    a: 0,
    e: '否定疑問に対し、期限が延びた事情を述べる応答。',
    w: ['正解。', 'Yes に続くのが「数字は誰にとっても大事だ」という一般論で、今日が期限かどうかとは独立している。肯定した内容の裏付けになっていない。', '数字の出どころ（監査由来か否か）を述べた文。出どころと提出期限は互いに独立で、期限が今日でも来週でも同じように成り立つ。'],
  ...
  p2(26, { t: ['p2wh'], lv: 4, sa: 'M-Br', sb: 'W-Am',
    ...
    c: ['A bit of both, actually.', 'Yes, we trained hard.', 'It starts Tuesday.'],
    a: 0,
    e: '選択疑問に「実は両方」と答え、二者択一を崩す応答。',
    w: ['正解。', '過去に受けた研修について述べており、今回の研修がオンラインか出張かという問いには答えていない。', '開始日を述べており、実施形式についての問いには答えていない。'],
  ...
  p2(28, { t: ['p2wh'], lv: 5, sa: 'M-Am', sb: 'W-Au',
    ...
    a: 2,
    e: 'Why don\'t we ...? は「〜してはどうか」という提案であると同時に、字義どおり「なぜ統合しないのか」とも読める形。どちらに取っても、応答は提案を受け入れるか、統合を妨げる事情を挙げるかになる。正解 (C) は「書式が違う」という具体的な障害を挙げている。Because で始まる応答が形として誤りになるわけではない（妨げになる事情を Because で導く返しは自然な英語）。判定は語の形ではなく、統合を妨げる事情を述べているかどうかで行う。',
    w: ['話題に出ているのは the two spreadsheets という 2 つの表で、単数の The spreadsheet ではそのどちらを指すのかが決まらない。仮に別の表を指しているとしても、タブが何枚あるかは 2 つを統合できるかどうかを左右しない（書式さえ揃っていれば枚数にかかわらず統合できる）。', 'merge の反復。Because で導かれる断片は「なぜ統合しないのか」への答えとして働くので、統合しない事情を述べることになるが、この応答の内容は「うまく統合できる」という統合を後押しする事実で、向きが逆。提案として受け取った場合も、同意の言葉も障害の指摘も含んでいない。2 つの表をまとめて受けるなら they merge well となる点も噛み合わない。', '正解。書式が違うという、統合を妨げる具体的な事情を挙げている。'],
