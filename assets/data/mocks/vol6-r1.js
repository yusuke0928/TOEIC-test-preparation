...
export const R1 = [
  ...
  p6({
    ...
    q: [
      { tag: '態', t: ['voice'],
        c: ['holding', 'will be holding', 'will be held', 'has been held'],
        a: 2,
        ...
        w: ['分詞。この節には定形動詞が他に無く、文の述語動詞になれない。',
            '能動の進行形。hold は「（催しを）開く」の意味では目的語を必要とするが、空所の後ろに目的語となる名詞句が無い。',
            '正解。will be held。hold の目的語にあたるものが主語に立った受動態で、催しの日はまだ先なので未来形。',
            '受動態だが現在完了。現在完了は現在までに起きた出来事を述べる形で、同じ文の will not be finished in time（工事は間に合わない）も、第 3 段落の before the sale opens to the public（販売会はこれから開場する）も、催しがまだ先であることを示している。'] },
      { tag: '語彙', t: ['quant'],
      ...
      { tag: '文挿入', t: ['p6ins'], id: 'v6q133r',
        c: [
          ...
          'Plants may only be reserved by visiting the membership office in person or telephoning during opening hours.',
        ...
        w: ['the spring show と既知のもののように指しているが、その催しは本文のどこにも出ておらず指示先が無い。段落は予約から受け取りまでの手順を追っており、品種の在庫数はこの連鎖に入らない。',
            ...
            '正解。'] },
      { tag: '接続語', t: ['connect'],
        c: ['Therefore', 'However', 'For example', 'Similarly'],
        a: 1,
  ...
  p6({
    ...
    q: [
      { tag: '態・時制', t: ['voice', 'ctense'],
        c: ['has been taken out of service', 'will be taken out of service', 'taking out of service', 'will be taking out of service'],
        a: 1,
        ...
        w: ['受動態だが現在完了。現在完了は現在までに起きたことを述べる形だが、次文の will instead be assessed / will not apply と、最終段落の before the work begins（工事が始まる前に新しい料金表を送る）が、閉鎖はまだ始まっていないことを示している。',
            '正解。will be taken out of service。take ... out of service の目的語にあたるものが主語に立った受動態で、閉鎖は 9 月 8 日からのこれからの出来事なので未来形。',
            '分詞。この節には定形動詞が他に無く、文の述語動詞になれない。',
            '能動の未来進行形。take と out の間に目的語となる名詞句が無い。'] },
    ...
    q: [
      ...
      { tag: '文挿入', t: ['p6ins'],
        c: [
          ...
          'Officials confirmed that no additional trucks or vans would use the terminal this year.',
        ],
        a: 2,
      ...
      { tag: '接続語', t: ['connect'],
        c: ['As an example', 'In spite of this', 'In the same way', 'As a result'],
        a: 3,
        e: '「日中シフトを延長すれば残業代がかさむ」という前文を受け、「だから新シフトを新設した」と結果を述べる因果関係。',
        w: ['例示。後続文は前文の具体例ではない。',
            'in spite of this は、前文が示す事情に逆らって後続の行動が取られたことを表す。前文の事情は「日中シフトを延長すれば残業代がかさむ」で、後続の「代わりに新しいシフトを新設した」はその残業代を避ける選択なので、逆らってはいない。',
            '並列。前後は同種の事柄の言い換えではない。',
            '正解。'] },
      ].map(x => ({ ...x, s: null })),
  }),
    ...
    q: [
      { tag: '接続語', t: ['connect'],
        ...
        w: ['因果。手間がかかることが、締切が必要なことの原因にはならない。',
            ...
            '並列。前後は同種の事柄の言い換えではない。'] },
      { tag: '態', t: ['voice'],
        c: ['had been countersigned', 'must be countersigned', 'countersigning', 'must be countersigning'],
        a: 1,
        ...
        w: ['受動態だが過去完了。過去完了は基準となる過去の時点より前を述べる形で、その基準になる過去の時点がこの文書のどこにも無い。文頭の Beginning next month は来月から始まる規定を示しており、過去完了とは両立しない。',
            '正解。must be countersigned。countersign の目的語にあたるものが主語に立った受動態で、義務を表す must に続く。',
            '分詞。この節には定形動詞が他に無く、文の述語動詞になれない。',
            '能動の進行形で、countersign の目的語となる名詞句が空所の後ろに無い。'] },
      { tag: '文挿入', t: ['p6ins'],
        c: [
