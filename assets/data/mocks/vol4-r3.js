...
export const R3 = [
  ...
  sp({
    ...
    docs: [{
      ...
      body: [
        'The programme replaced 86 drinking fountains with combined refill stations over nine months, against a plan of 110. The 24 outstanding are all in the riverside park and are covered by a separate flood-defence scheme due next year. — [[1]] —',
        'On cost, the programme came in 4 percent under budget. On timing, it finished two weeks late, which Corvenna attributes to unexpected ground conditions near two of the sites. Neither figure is unusual for work of this kind. — [[2]] —',
    ...
    q: [
      ...
      { tag: '詳細', s: 'What is stated about the cost of the replacement spouts?',
        c: ['The unit price rose but total spending fell.', 'Both the unit price and total spending fell together.',
            'The unit price was unchanged throughout the programme.', 'Total spending rose sharply in the first year.'],
        a: 0,
        e: '1 基あたりは 45 パーセント高いが、破損件数が 58 → 19 に減ったため総額は 64 パーセント減。',
        w: ['正解。', '単価は上がっている。', '1 基あたりの交換費用は 45 パーセント高いと明記されている。', '総額は初年度に 64 パーセント減っており、上昇ではない。'] },
      { tag: '位置選択', qid: 'v4q174r', t: ['p7ins'], insertAt: 1,
        sentence: 'Corvenna Civil Ltd, the contractor for the whole programme, had warned that the tight nine-month schedule left little room for delay.',
        s: 'In which of the positions marked [1], [2], [3], and [4] does the following sentence best belong?　"Corvenna Civil Ltd, the contractor for the whole programme, had warned that the tight nine-month schedule left little room for delay."',
        c: ['[1]', '[2]', '[3]', '[4]'],
        a: 0,
        e: '挿入文は Corvenna Civil Ltd という固有名を「the contractor for the whole programme」という説明つきで初めて導入している。第2段落はこの会社を短縮した固有名 Corvenna だけで指しており、固有名は世界知識から推測できないため、それより前に一度は正式名で導入されていなければ読者は誰のことか分からない。それが成立するのは [1] だけである。',
        w: ['正解。挿入文がフルネームで Corvenna Civil Ltd を導入するのはこの位置だけで、直後の第2段落にある Corvenna という短縮名が、直前で導入された相手を指す形として成立する。',
            '[2] に置くと、第2段落の Corvenna という固有名がすでに本文中に現れたあとで、挿入文によるフルネームでの導入が行われることになる。固有名は文脈から推測できないため、まだ一度も名指しされていない相手を第2段落が指してしまっており、成立しない。',
            '[3] に置くと、第2段落の Corvenna が挿入文より先に現れることになり、誰を指すか定まらないまま固有名が使われている。',
            '[4] に置くと、第2段落の Corvenna からさらに離れたあとで Corvenna Civil Ltd がフルネームで「初めて」導入されることになり、すでに短縮名で扱われていた相手を今さら初出の形で導入し直す矛盾が生じる。'] },
      { tag: '推測', t: ['p7inf'], s: 'What does the report conclude about unit price?',
        c: ['It should be the primary criterion for future purchases.', 'It is a misleading measure in this category.',
            'It should prompt a renegotiation with the contractor before work starts.', 'It will fall once volumes increase, matching the pattern seen in total spending.'],
        a: 1,
        e: '「この分野では単価は生涯費用の目安として不適切だと委員会が扱うよう勧告する」とある。',
        w: ['むしろ主要基準にすべきでないと述べている。', '正解。', '単価が高くても河畔公園に同じ仕様を導入するよう勧告しており、再交渉の勧告はない。', '総額が減った理由は破損件数の低下であり、数量による単価下落には触れていない。'] },
    ],
  }),
];
