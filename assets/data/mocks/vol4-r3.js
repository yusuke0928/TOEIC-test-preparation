  ...
  sp({
    ...
    q: [
      ...
      { tag: '詳細', s: "Why can't the brochures be fully reprinted before the show?",
        c: ['The vendor has no printing capacity until next month.', 'The original design files have been lost by the vendor.',
    ...
    q: [
      ...
      { tag: '推測', t: ['p7inf'], s: 'What does the report conclude about unit price?',
        c: ['It should be the primary criterion for future purchases.', 'It is a misleading measure in this category.',
            'It should be renegotiated with the contractor before the riverside stations are installed.', 'It will fall once volumes increase, matching the pattern seen in total spending.'],
        a: 1,
