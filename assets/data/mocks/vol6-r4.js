  ...
  mp({
    ...
    q: [
      ...
      { tag: '推測', t: ['p7inf'], s: "What is suggested about the Business Skills category?",
        c: ['It requires more hours than Technical Practice from members working part-time.', "It was removed from this year's requirement after last year's review.",
    ...
    q: [
      ...
      { tag: '詳細', qid: 'v6q194r', s: 'What does Ms. Sowande say about the individual data sheets?',
        c: ['They are sent automatically with the summary report.',
            ...
            'They are issued two weeks after the summary report is signed off.',
        ...
        w: ['文書3は「報告書が承認される前に依頼しておく必要がある」と明記しており、依頼なしに自動で付くという内容と矛盾する。',
            ...
            '文書3は「報告書が承認されたあとには追加できない」と述べており、あとから出るという内容と矛盾する。承認完了のタイミングで自動的に発行されるという記述もない。',
            '正解。'] },
  ...
  mp({
    ...
    q: [
      ...
      { tag: '詳細', qid: 'v6q200r', s: "What does Ms. Attah say the store has changed about handling new CK-210 stock?",
        c: ['It will wait for a customer to ask before checking new stock.', 'It will stop ordering the CK-210 model altogether.',
        ...
        w: ['文書3はむしろ「客に聞かれたときだけでなく」入荷時点で確認すると述べており、客の申し出を待つという内容と正反対。', 'CK-210の発注を取りやめるとは述べていない。', '新規入荷品の脇にリコール通知を掲示するとは述べていない。',
            '正解。'] },
    ],
  }),
];
