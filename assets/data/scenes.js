...
export const SCENES = {
  ...
  /* 12. 川と橋：ボートが橋の近くに停泊している（人物なし）
     ...
     既知の見え方の問題（2026-08-18 の全数検査で確認）：船体の台形が**上下逆**で、
     底辺（y=214/222）のほうが上辺（y=196/204）より広い。実物の船は喫水側が狭いので、
     544px では「ランプシェード／小卓に棒が刺さったもの」に見え、boat/vessel と
     読み取るのは難しい。橋も水平の帯と縦棒の集まりで、橋だと分かるのは橋脚
     （x=210・x=400 が水面 y=170 を跨いで y=202 まで下りていること）だけ。
     **船・橋の「見た目」に依存する新しい正解文（帆・船首・アーチなど）は書かないこと。**
     現行 3 問はいずれも「人が 1 人も写っていない」ことで誤答を消せるので成立している。 */
  'waterfront': frame(`
